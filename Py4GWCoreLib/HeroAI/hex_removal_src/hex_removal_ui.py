"""Py4GWCoreLib/HeroAI/hex_removal_src/hex_removal_ui.py - Hex Removal configuration tab.
...
action. An "Info" sub-tab gives a short usage cheat-sheet. All
    persistence delegates to Py4GWCoreLib.HeroAI.hex_removal_src.hex_removal_config.
"""
