...
class DrawList:
    ...
    # clipping
    def push_clip_rect(self, clip_min: Sequence[float], clip_max: Sequence[float], intersect_with_current: bool = False) -> None: ...
    ...
    def add_rect(self, p_min: Sequence[float], p_max: Sequence[float], col: int, rounding: float = 0.0, flags: int = 0, thickness: float = 1.0) -> None: ...
    def add_rect_filled(self, p_min: Sequence[float], p_max: Sequence[float], col: int, rounding: float = 0.0, flags: int = 0) -> None: ...
    def add_rect_filled_multi_color(self, p_min: Sequence[float], p_max: Sequence[float], col_upr_left: int, col_upr_right: int, col_bot_right: int, col_bot_left: int) -> None: ...
    def add_quad(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], col: int, thickness: float = 1.0) -> None: ...
    def add_quad_filled(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], col: int) -> None: ...
    def add_triangle(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], col: int, thickness: float = 1.0) -> None: ...
    def add_triangle_filled(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], col: int) -> None: ...
    def add_circle(self, center: Sequence[float], radius: float, col: int, num_segments: int = 0, thickness: float = 1.0) -> None: ...
    def add_circle_filled(self, center: Sequence[float], radius: float, col: int, num_segments: int = 0) -> None: ...
    def add_ngon(self, center: Sequence[float], radius: float, col: int, num_segments: int, thickness: float = 1.0) -> None: ...
    def add_ngon_filled(self, center: Sequence[float], radius: float, col: int, num_segments: int) -> None: ...
    def add_ellipse(self, center: Sequence[float], radius: Sequence[float], col: int, rot: float = 0.0, num_segments: int = 0, thickness: float = 1.0) -> None: ...
    def add_ellipse_filled(self, center: Sequence[float], radius: Sequence[float], col: int, rot: float = 0.0, num_segments: int = 0) -> None: ...
    def add_text(self, pos: Sequence[float], col: int, text: str) -> None: ...
    def add_bezier_cubic(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], col: int, thickness: float, num_segments: int = 0) -> None: ...
    def add_bezier_quadratic(self, p1: Sequence[float], p2: Sequence[float], p3: Sequence[float], col: int, thickness: float, num_segments: int = 0) -> None: ...
    def add_polyline(self, points: Sequence[Sequence[float]], col: int, flags: int = 0, thickness: float = 1.0) -> None: ...
    ...
    def path_arc_to(self, center: Sequence[float], radius: float, a_min: float, a_max: float, num_segments: int = 0) -> None: ...
    def path_arc_to_fast(self, center: Sequence[float], radius: float, a_min_of_12: int, a_max_of_12: int) -> None: ...
    def path_elliptical_arc_to(self, center: Sequence[float], radius: Sequence[float], rot: float, a_min: float, a_max: float, num_segments: int = 0) -> None: ...
    def path_bezier_cubic_curve_to(self, p2: Sequence[float], p3: Sequence[float], p4: Sequence[float], num_segments: int = 0) -> None: ...
    def path_bezier_quadratic_curve_to(self, p2: Sequence[float], p3: Sequence[float], num_segments: int = 0) -> None: ...
    def path_rect(self, rect_min: Sequence[float], rect_max: Sequence[float], rounding: float = 0.0, flags: int = 0) -> None: ...
...
# Py4GWCoreLib/__init__.py wraps this at import so legacy (w, h) call sites keep
# working alongside the Reforged single-Vec2 form. Both spellings are live.
@overload
def is_rect_visible(size: Sequence[float]) -> bool: ...
@overload
def is_rect_visible(w: float, h: float) -> bool: ...
...
@overload
def dummy(w: float, h: float) -> None: ...
...
@overload
def invisible_button(str_id: str, w: float, h: float, flags: int = 0) -> bool: ...
...
def v_slider_float(label: str, size: Sequence[float], v: float, v_min: float, v_max: float, format: str = "%.3f", flags: int = 0) -> float: ...
def v_slider_int(label: str, size: Sequence[float], v: int, v_min: int, v_max: int, format: str = "%d", flags: int = 0) -> int: ...
def slider_float2(label: str, v: Sequence[float], v_min: float, v_max: float, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def slider_float3(label: str, v: Sequence[float], v_min: float, v_max: float, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def slider_float4(label: str, v: Sequence[float], v_min: float, v_max: float, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def slider_int2(label: str, v: Sequence[int], v_min: int, v_max: int, format: str = "%d", flags: int = 0) -> List[int]: ...
def slider_int3(label: str, v: Sequence[int], v_min: int, v_max: int, format: str = "%d", flags: int = 0) -> List[int]: ...
def slider_int4(label: str, v: Sequence[int], v_min: int, v_max: int, format: str = "%d", flags: int = 0) -> List[int]: ...

# Drags
def drag_float(label: str, v: float, v_speed: float = 1.0, v_min: float = 0.0, v_max: float = 0.0, format: str = "%.3f", flags: int = 0) -> float: ...
def drag_float_range2(label: str, v_current_min: float, v_current_max: float, v_speed: float = 1.0, v_min: float = 0.0, v_max: float = 0.0, format: str = "%.3f", format_max: Optional[str] = None, flags: int = 0) -> Tuple[float, float]: ...
def drag_int(label: str, v: int, v_speed: float = 1.0, v_min: int = 0, v_max: int = 0, format: str = "%d", flags: int = 0) -> int: ...
def drag_int_range2(label: str, v_current_min: int, v_current_max: int, v_speed: float = 1.0, v_min: int = 0, v_max: int = 0, format: str = "%d", format_max: Optional[str] = None, flags: int = 0) -> Tuple[int, int]: ...
def drag_float2(label: str, v: Sequence[float], v_speed: float = 1.0, v_min: float = 0.0, v_max: float = 0.0, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def drag_float3(label: str, v: Sequence[float], v_speed: float = 1.0, v_min: float = 0.0, v_max: float = 0.0, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def drag_float4(label: str, v: Sequence[float], v_speed: float = 1.0, v_min: float = 0.0, v_max: float = 0.0, format: str = "%.3f", flags: int = 0) -> List[float]: ...
def drag_int2(label: str, v: Sequence[int], v_speed: float = 1.0, v_min: int = 0, v_max: int = 0, format: str = "%d", flags: int = 0) -> List[int]: ...
def drag_int3(label: str, v: Sequence[int], v_speed: float = 1.0, v_min: int = 0, v_max: int = 0, format: str = "%d", flags: int = 0) -> List[int]: ...
def drag_int4(label: str, v: Sequence[int], v_speed: float = 1.0, v_min: int = 0, v_max: int = 0, format: str = "%d", flags: int = 0) -> List[int]: ...
...
def image_with_bg(tex_id: int, size: Sequence[float], uv0: Sequence[float] = (0, 0), uv1: Sequence[float] = (1, 1), bg_col: Sequence[float] = (0, 0, 0, 0), tint_col: Sequence[float] = (1, 1, 1, 1)) -> None: ...
def image_button(str_id: str, tex_id: int, size: Sequence[float], uv0: Sequence[float] = (0, 0), uv1: Sequence[float] = (1, 1), bg_col: Sequence[float] = (0, 0, 0, 0), tint_col: Sequence[float] = (1, 1, 1, 1)) -> bool: ...
...
def begin_tab_item(label: str, p_open: Optional[bool] = None, flags: int = 0) -> bool:
    """p_open is a raw bool* and only accepts None. Use begin_tab_item_closable()
...
# ---- TABLES --------
@overload
def begin_table(str_id: str, column: int, flags: int = 0, outer_size: Sequence[float] = (0, 0), inner_width: float = 0.0) -> bool: ...
@overload
...
# ---- CLIP RECT --------
@overload
def push_clip_rect(clip_rect_min: Sequence[float], clip_rect_max: Sequence[float], intersect_with_current_clip_rect: bool) -> None: ...
@overload
...
def calc_text_size(text: str, text_end: Optional[str] = None, hide_text_after_double_hash: bool = False, wrap_width: float = -1.0) -> Tuple[float, float]: ...
def get_font() -> Any: ...
...
def plot_lines(label: str, values: Sequence[float], values_offset: int = 0, overlay_text: Optional[str] = None, scale_min: float = 3.4028235e38, scale_max: float = 3.4028235e38, graph_size: Sequence[float] = (0, 0)) -> None: ...
def plot_histogram(label: str, values: Sequence[float], values_offset: int = 0, overlay_text: Optional[str] = None, scale_min: float = 3.4028235e38, scale_max: float = 3.4028235e38, graph_size: Sequence[float] = (0, 0)) -> None: ...
...
class _FileBrowser:
    ...
    ext: str
    def __init__(self) -> None: ...
    def show_file_dialog(self, label: str, mode: _FileBrowserDialogMode, size: Sequence[float] = (0.0, 0.0), valid_types: str = '*.*') -> bool: ...
...
class _AnimModule:
    ...
    def tween_float(self, id: int, channel_id: int, target: float, duration: float, ease: int = 5, policy: int = 0, dt: float = 0.0, init_value: float = 0.0) -> float:
        """Defaults: ease = Ease.OutCubic (5), policy = Policy.Crossfade (0)."""
        ...
    def oscillate(self, id: int, amplitude: float, frequency: float, wave_type: int = 0, phase: float = 0.0, dt: float = 0.0) -> float: ...
...
class _ImPlotModule:
    ...
    def begin_subplots(self, title_id: str, rows: int, cols: int, width: float, height: float, flags: int = 0, row_ratios: Optional[Sequence[float]] = None, col_ratios: Optional[Sequence[float]] = None) -> bool: ...
    ...
    def setup_axis_ticks(self, axis: int, values: Sequence[float], labels: Sequence[str] = ..., keep_default: bool = False) -> None: ...
    def setup_axis_ticks_range(self, axis: int, v_min: float, v_max: float, n_ticks: int, labels: Sequence[str] = ..., keep_default: bool = False) -> None: ...
    ...
    def plot_line(self, label: str, values: Sequence[float], xscale: float = 1.0, xstart: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_line_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_scatter(self, label: str, values: Sequence[float], xscale: float = 1.0, xstart: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_scatter_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_stairs(self, label: str, values: Sequence[float], xscale: float = 1.0, xstart: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_stairs_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_shaded(self, label: str, values: Sequence[float], yref: float = 0.0, xscale: float = 1.0, xstart: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_shaded_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], yref: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_shaded_between(self, label: str, xs: Sequence[float], ys1: Sequence[float], ys2: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_bars(self, label: str, values: Sequence[float], bar_size: float = 0.67, shift: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_bars_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], bar_size: float = 0.67, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_bar_groups(self, label_ids: Sequence[str], values: Sequence[float], item_count: int, group_count: int, group_size: float = 0.67, shift: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_error_bars(self, label: str, xs: Sequence[float], ys: Sequence[float], err: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_error_bars_asym(self, label: str, xs: Sequence[float], ys: Sequence[float], neg: Sequence[float], pos: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_stems(self, label: str, values: Sequence[float], ref: float = 0.0, scale: float = 1.0, start: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_stems_xy(self, label: str, xs: Sequence[float], ys: Sequence[float], ref: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_inf_lines(self, label: str, values: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_pie_chart(self, label_ids: Sequence[str], values: Sequence[float], x: float, y: float, radius: float, label_fmt: str = "%.1f", angle0: float = 90.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_heatmap(self, label: str, values: Sequence[float], rows: int, cols: int, scale_min: float = 0.0, scale_max: float = 0.0, label_fmt: str = "%.1f", bounds_min_x: float = 0.0, bounds_min_y: float = 0.0, bounds_max_x: float = 1.0, bounds_max_y: float = 1.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    def plot_histogram(self, label: str, values: Sequence[float], bins: int = ..., bar_scale: float = 1.0, range_min: float = 0.0, range_max: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> float: ...
    def plot_histogram_2d(self, label: str, xs: Sequence[float], ys: Sequence[float], x_bins: int = ..., y_bins: int = ..., x_min: float = 0.0, x_max: float = 0.0, y_min: float = 0.0, y_max: float = 0.0, spec: "_ImPlotModule.ImPlotSpec" = ...) -> float: ...
    def plot_digital(self, label: str, xs: Sequence[float], ys: Sequence[float], spec: "_ImPlotModule.ImPlotSpec" = ...) -> None: ...
    ...
    def colormap_slider(self, label: str, t: float, format: str = "", cmap: int = ...) -> Tuple[bool, float, _ColOut]: ...
